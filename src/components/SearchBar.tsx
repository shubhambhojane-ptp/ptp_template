...
const SearchBar = ({ className = '', containerClassName = '', ...props }: SearchBarProps) => {
  return (
    <div
      className={twMerge(
    ...
    >
      ...
      <input
        type="text"
        className={twMerge('w-full bg-transparent text-sm outline-none placeholder:text-gray-400 sm:text-base', className)}
        {...props}
      />
    </div>
  )
